...
ggplot(age_concern, aes(Q9_3, count, fill = Q2)) + geom_bar(position = "dodge", stat = "summary", fun = "mean")

kruskal.test(Q9_3~Q2, survey)
dunnTest(Q9_3~Q2, survey)

q9 <- read.csv("C:\\Users\\lmlev\\iCloudDrive\\UMN\\Bayer Fellowship\\Q9_3.csv")
q9$Q2 <- as.factor(q9$ï..Q2)
ggplot(q9, aes(as.factor(Q9), perc, fill = Q2)) + geom_bar(position = "dodge", stat = "summary", fun = "mean") + geom_text(aes(label = perc), position = position_dodge(0.9), vjust = 2)
